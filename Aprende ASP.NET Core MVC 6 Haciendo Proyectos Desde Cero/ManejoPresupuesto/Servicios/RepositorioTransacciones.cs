...
namespace ManejoPresupuesto.Servicios{
    public class RepositorioTransaccion : IRepositorioTransacciones{
        ...
        public async Task<IEnumerable<Transaccion>> ObtenerPorCuentaId(ObtenerTransaccionesPorCuenta modelo){
            ...
            Console.WriteLine("\nObteniendo cuenta por ID de\n");
            Console.WriteLine("\nUsuario: " + modelo.UsuarioId + "\nCuenta: " + modelo.CuentaId + "\nFecha inicio: " + modelo.FechaInicio + "\nFecha Fin: " + modelo.FechaFin);

            var transacciones = await connection.QueryAsync<Transaccion>
            ...
            foreach(var transaccion in transacciones){ // Error obtiene fechas de hoy aunque en la tabla se hayan creado en otras fechas
